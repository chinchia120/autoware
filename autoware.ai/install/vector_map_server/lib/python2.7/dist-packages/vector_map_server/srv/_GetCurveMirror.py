...
"""autogenerated by genpy from vector_map_server/GetCurveMirrorRequest.msg. Do not edit."""
import codecs
import sys
...
class GetCurveMirrorRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetCurveMirrorRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetCurveMirrorRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetCurveMirrorResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetCurveMirrorResponse(genpy.Message):
  _md5sum = "f732ad08b3dfca284d5b449085c29ad7"
  _type = "vector_map_server/GetCurveMirrorResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/CurveMirrorArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/CurveMirrorArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetCurveMirrorResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.CurveMirrorArray()
    else:
      self.objects = vector_map_msgs.msg.CurveMirrorArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.CurveMirror()
        _x = val1
        start = end
        end += 20
...
def _get_struct_5i():
    ...
    return _struct_5i
class GetCurveMirror(object):
  _type          = 'vector_map_server/GetCurveMirror'
  _md5sum = 'b860d85d27a86767811f84071a5ca44b'
  _request_class  = GetCurveMirrorRequest
  _response_class = GetCurveMirrorResponse
