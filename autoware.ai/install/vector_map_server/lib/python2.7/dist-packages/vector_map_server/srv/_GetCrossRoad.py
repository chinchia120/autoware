...
"""autogenerated by genpy from vector_map_server/GetCrossRoadRequest.msg. Do not edit."""
import codecs
import sys
...
class GetCrossRoadRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetCrossRoadRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetCrossRoadRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetCrossRoadResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetCrossRoadResponse(genpy.Message):
  _md5sum = "3e2316da16f47f9b9b59ab373d7ae8a5"
  _type = "vector_map_server/GetCrossRoadResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/CrossRoadArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/CrossRoadArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetCrossRoadResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.CrossRoadArray()
    else:
      self.objects = vector_map_msgs.msg.CrossRoadArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.CrossRoad()
        _x = val1
        start = end
        end += 12
...
def _get_struct_3i():
    ...
    if _struct_3i is None:
        _struct_3i = struct.Struct("<3i")
    return _struct_3i
class GetCrossRoad(object):
  _type          = 'vector_map_server/GetCrossRoad'
  _md5sum = '960088d98f027e8a008897cb0578f71b'
  _request_class  = GetCrossRoadRequest
  _response_class = GetCrossRoadResponse
