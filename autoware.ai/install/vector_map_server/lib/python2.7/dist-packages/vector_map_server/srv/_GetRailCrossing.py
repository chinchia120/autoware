...
"""autogenerated by genpy from vector_map_server/GetRailCrossingRequest.msg. Do not edit."""
import codecs
import sys
...
class GetRailCrossingRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetRailCrossingRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetRailCrossingRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetRailCrossingResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetRailCrossingResponse(genpy.Message):
  _md5sum = "3e2316da16f47f9b9b59ab373d7ae8a5"
  _type = "vector_map_server/GetRailCrossingResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/RailCrossingArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/RailCrossingArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetRailCrossingResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.RailCrossingArray()
    else:
      self.objects = vector_map_msgs.msg.RailCrossingArray()
...
def _get_struct_3i():
    ...
    if _struct_3i is None:
        _struct_3i = struct.Struct("<3i")
    return _struct_3i
class GetRailCrossing(object):
  _type          = 'vector_map_server/GetRailCrossing'
  _md5sum = '960088d98f027e8a008897cb0578f71b'
  _request_class  = GetRailCrossingRequest
  _response_class = GetRailCrossingResponse
