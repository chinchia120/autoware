...
"""autogenerated by genpy from vector_map_server/GetGutterRequest.msg. Do not edit."""
import codecs
import sys
...
class GetGutterRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetGutterRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetGutterRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetGutterResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetGutterResponse(genpy.Message):
  _md5sum = "d22dfd7486b230c3bff13380d5a93645"
  _type = "vector_map_server/GetGutterResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/GutterArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/GutterArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetGutterResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.GutterArray()
    else:
      self.objects = vector_map_msgs.msg.GutterArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.Gutter()
        _x = val1
        start = end
        end += 16
...
def _get_struct_4i():
    ...
    return _struct_4i
class GetGutter(object):
  _type          = 'vector_map_server/GetGutter'
  _md5sum = '505cbe553f3c35874d30bafa749b039f'
  _request_class  = GetGutterRequest
  _response_class = GetGutterResponse
