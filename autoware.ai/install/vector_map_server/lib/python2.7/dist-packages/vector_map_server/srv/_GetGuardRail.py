...
"""autogenerated by genpy from vector_map_server/GetGuardRailRequest.msg. Do not edit."""
import codecs
import sys
...
class GetGuardRailRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetGuardRailRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetGuardRailRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetGuardRailResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetGuardRailResponse(genpy.Message):
  _md5sum = "dfb68cd4dfb7fafca860fa32531caf66"
  _type = "vector_map_server/GetGuardRailResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/GuardRailArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/GuardRailArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetGuardRailResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.GuardRailArray()
    else:
      self.objects = vector_map_msgs.msg.GuardRailArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.GuardRail()
        _x = val1
        start = end
        end += 16
...
def _get_struct_4i():
    ...
    return _struct_4i
class GetGuardRail(object):
  _type          = 'vector_map_server/GetGuardRail'
  _md5sum = '9722667ca9b8d40b70c4d7e1b16e9ea0'
  _request_class  = GetGuardRailRequest
  _response_class = GetGuardRailResponse
