...
"""autogenerated by genpy from vector_map_server/GetRoadSignRequest.msg. Do not edit."""
import codecs
import sys
...
class GetRoadSignRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetRoadSignRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetRoadSignRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetRoadSignResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetRoadSignResponse(genpy.Message):
  _md5sum = "eb0d3abd5b660952db66a2eaaffb9728"
  _type = "vector_map_server/GetRoadSignResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/RoadSignArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/RoadSignArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetRoadSignResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.RoadSignArray()
    else:
      self.objects = vector_map_msgs.msg.RoadSignArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.RoadSign()
        _x = val1
        start = end
        end += 20
...
def _get_struct_5i():
    ...
    return _struct_5i
class GetRoadSign(object):
  _type          = 'vector_map_server/GetRoadSign'
  _md5sum = 'be65e7050b7091d7f692d42aee88a231'
  _request_class  = GetRoadSignRequest
  _response_class = GetRoadSignResponse
