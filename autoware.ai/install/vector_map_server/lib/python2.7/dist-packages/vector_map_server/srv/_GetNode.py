...
"""autogenerated by genpy from vector_map_server/GetNodeRequest.msg. Do not edit."""
import codecs
import sys
...
class GetNodeRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetNodeRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetNodeRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetNodeResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetNodeResponse(genpy.Message):
  _md5sum = "8948a4f88cd78eafaa373398537426d7"
  _type = "vector_map_server/GetNodeResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/NodeArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/NodeArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetNodeResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.NodeArray()
    else:
      self.objects = vector_map_msgs.msg.NodeArray()
...
class GetNode(object):
  _type          = 'vector_map_server/GetNode'
  _md5sum = '18128901a5e61bc54c635df3d3633f33'
  _request_class  = GetNodeRequest
  _response_class = GetNodeResponse
