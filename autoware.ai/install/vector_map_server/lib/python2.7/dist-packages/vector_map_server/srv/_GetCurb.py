...
"""autogenerated by genpy from vector_map_server/GetCurbRequest.msg. Do not edit."""
import codecs
import sys
...
class GetCurbRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetCurbRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetCurbRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetCurbResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetCurbResponse(genpy.Message):
  _md5sum = "247679ac4822925e3121eb015d22543b"
  _type = "vector_map_server/GetCurbResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/CurbArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/CurbArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetCurbResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.CurbArray()
    else:
      self.objects = vector_map_msgs.msg.CurbArray()
...
def _get_struct_3I():
    ...
    if _struct_3I is None:
        _struct_3I = struct.Struct("<3I")
    return _struct_3I
class GetCurb(object):
  _type          = 'vector_map_server/GetCurb'
  _md5sum = '28da9385b8b41ad0a9d9d7399a4ae4e2'
  _request_class  = GetCurbRequest
  _response_class = GetCurbResponse
