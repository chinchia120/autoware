...
"""autogenerated by genpy from vector_map_server/GetZebraZoneRequest.msg. Do not edit."""
import codecs
import sys
...
class GetZebraZoneRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetZebraZoneRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetZebraZoneRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetZebraZoneResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetZebraZoneResponse(genpy.Message):
  _md5sum = "3e2316da16f47f9b9b59ab373d7ae8a5"
  _type = "vector_map_server/GetZebraZoneResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/ZebraZoneArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/ZebraZoneArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetZebraZoneResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.ZebraZoneArray()
    else:
      self.objects = vector_map_msgs.msg.ZebraZoneArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.ZebraZone()
        _x = val1
        start = end
        end += 12
...
def _get_struct_3i():
    ...
    if _struct_3i is None:
        _struct_3i = struct.Struct("<3i")
    return _struct_3i
class GetZebraZone(object):
  _type          = 'vector_map_server/GetZebraZone'
  _md5sum = '960088d98f027e8a008897cb0578f71b'
  _request_class  = GetZebraZoneRequest
  _response_class = GetZebraZoneResponse
