...
"""autogenerated by genpy from vector_map_server/GetRoadMarkRequest.msg. Do not edit."""
import codecs
import sys
...
class GetRoadMarkRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetRoadMarkRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetRoadMarkRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetRoadMarkResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetRoadMarkResponse(genpy.Message):
  _md5sum = "940ffa72a3b35e28520d814d5291ea3f"
  _type = "vector_map_server/GetRoadMarkResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/RoadMarkArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/RoadMarkArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetRoadMarkResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.RoadMarkArray()
    else:
      self.objects = vector_map_msgs.msg.RoadMarkArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.RoadMark()
        _x = val1
        start = end
        end += 16
...
def _get_struct_4i():
    ...
    return _struct_4i
class GetRoadMark(object):
  _type          = 'vector_map_server/GetRoadMark'
  _md5sum = 'ad9b450340842efc70293ff26210d059'
  _request_class  = GetRoadMarkRequest
  _response_class = GetRoadMarkResponse
