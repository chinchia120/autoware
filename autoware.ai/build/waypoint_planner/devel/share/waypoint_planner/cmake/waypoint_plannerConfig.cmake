...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_planner_SOURCE_PREFIX /home/point001/autoware.ai/src/autoware/core_planning/waypoint_planner)
  set(waypoint_planner_DEVEL_PREFIX /home/point001/autoware.ai/build/waypoint_planner/devel)
  ...
  set(waypoint_planner_INSTALL_PREFIX /home/point001/autoware.ai/install/waypoint_planner)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/point001/autoware.ai/src/autoware/core_planning/waypoint_planner/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT waypoint_planner_NUM_DUMMY_TARGETS)
      set(waypoint_planner_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::waypoint_planner::wrapped-linker-option${waypoint_planner_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR waypoint_planner_NUM_DUMMY_TARGETS "${waypoint_planner_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::waypoint_planner::wrapped-linker-option${waypoint_planner_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND waypoint_planner_LIBRARIES "${interface_target_name}")
