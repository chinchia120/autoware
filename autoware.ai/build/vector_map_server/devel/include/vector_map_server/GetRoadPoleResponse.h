...
bool operator==(const ::vector_map_server::GetRoadPoleResponse_<ContainerAllocator1> & lhs, const ::vector_map_server::GetRoadPoleResponse_<ContainerAllocator2> & rhs)
{
