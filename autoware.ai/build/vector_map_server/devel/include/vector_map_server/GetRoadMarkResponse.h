...
bool operator==(const ::vector_map_server::GetRoadMarkResponse_<ContainerAllocator1> & lhs, const ::vector_map_server::GetRoadMarkResponse_<ContainerAllocator2> & rhs)
{
