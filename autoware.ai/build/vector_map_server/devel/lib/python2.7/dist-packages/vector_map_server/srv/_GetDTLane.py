...
"""autogenerated by genpy from vector_map_server/GetDTLaneRequest.msg. Do not edit."""
import codecs
import sys
...
class GetDTLaneRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetDTLaneRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetDTLaneRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetDTLaneResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetDTLaneResponse(genpy.Message):
  _md5sum = "d8d90427357d4b8c8ade256226853bb6"
  _type = "vector_map_server/GetDTLaneResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/DTLaneArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/DTLaneArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetDTLaneResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.DTLaneArray()
    else:
      self.objects = vector_map_msgs.msg.DTLaneArray()
...
class GetDTLane(object):
  _type          = 'vector_map_server/GetDTLane'
  _md5sum = '865ceda06685d4c4a955df45a34b30d2'
  _request_class  = GetDTLaneRequest
  _response_class = GetDTLaneResponse
