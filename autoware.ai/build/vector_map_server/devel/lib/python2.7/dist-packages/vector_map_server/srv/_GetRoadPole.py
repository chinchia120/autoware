...
"""autogenerated by genpy from vector_map_server/GetRoadPoleRequest.msg. Do not edit."""
import codecs
import sys
...
class GetRoadPoleRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetRoadPoleRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetRoadPoleRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetRoadPoleResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetRoadPoleResponse(genpy.Message):
  _md5sum = "38d3858578c73c6b13fdf06be65fa9aa"
  _type = "vector_map_server/GetRoadPoleResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/RoadPoleArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/RoadPoleArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetRoadPoleResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.RoadPoleArray()
    else:
      self.objects = vector_map_msgs.msg.RoadPoleArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.RoadPole()
        _x = val1
        start = end
        end += 12
...
def _get_struct_3i():
    ...
    if _struct_3i is None:
        _struct_3i = struct.Struct("<3i")
    return _struct_3i
class GetRoadPole(object):
  _type          = 'vector_map_server/GetRoadPole'
  _md5sum = '3b25ea5b9fa557d465998026b3095820'
  _request_class  = GetRoadPoleRequest
  _response_class = GetRoadPoleResponse
