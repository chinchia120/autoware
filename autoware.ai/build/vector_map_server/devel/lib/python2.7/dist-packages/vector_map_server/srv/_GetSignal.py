...
"""autogenerated by genpy from vector_map_server/GetSignalRequest.msg. Do not edit."""
import codecs
import sys
...
class GetSignalRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetSignalRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetSignalRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetSignalResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetSignalResponse(genpy.Message):
  _md5sum = "0ca09edef892e41c0efa106b26ce82cc"
  _type = "vector_map_server/GetSignalResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/SignalArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/SignalArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetSignalResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.SignalArray()
    else:
      self.objects = vector_map_msgs.msg.SignalArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.Signal()
        _x = val1
        start = end
        end += 20
...
class GetSignal(object):
  _type          = 'vector_map_server/GetSignal'
  _md5sum = '29fe775071aab23283d567337e95c279'
  _request_class  = GetSignalRequest
  _response_class = GetSignalResponse
