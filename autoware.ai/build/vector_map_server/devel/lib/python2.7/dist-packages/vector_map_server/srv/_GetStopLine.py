...
"""autogenerated by genpy from vector_map_server/GetStopLineRequest.msg. Do not edit."""
import codecs
import sys
...
class GetStopLineRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetStopLineRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetStopLineRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetStopLineResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetStopLineResponse(genpy.Message):
  _md5sum = "174113739c15edc9a40a21167b2f26f5"
  _type = "vector_map_server/GetStopLineResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/StopLineArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/StopLineArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetStopLineResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.StopLineArray()
    else:
      self.objects = vector_map_msgs.msg.StopLineArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.StopLine()
        _x = val1
        start = end
        end += 20
...
def _get_struct_5i():
    ...
    return _struct_5i
class GetStopLine(object):
  _type          = 'vector_map_server/GetStopLine'
  _md5sum = 'e296bb40cdd6d92ca8774f5bba228c13'
  _request_class  = GetStopLineRequest
  _response_class = GetStopLineResponse
