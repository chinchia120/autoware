...
"""autogenerated by genpy from vector_map_server/GetCrossWalkRequest.msg. Do not edit."""
import codecs
import sys
...
class GetCrossWalkRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetCrossWalkRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetCrossWalkRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetCrossWalkResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetCrossWalkResponse(genpy.Message):
  _md5sum = "36a0e37fbe771afc34a2d7c0116919f9"
  _type = "vector_map_server/GetCrossWalkResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/CrossWalkArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/CrossWalkArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetCrossWalkResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.CrossWalkArray()
    else:
      self.objects = vector_map_msgs.msg.CrossWalkArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.CrossWalk()
        _x = val1
        start = end
        end += 20
...
def _get_struct_5i():
    ...
    return _struct_5i
class GetCrossWalk(object):
  _type          = 'vector_map_server/GetCrossWalk'
  _md5sum = '5eaa88405db0c4e45d229b723f6f1eb2'
  _request_class  = GetCrossWalkRequest
  _response_class = GetCrossWalkResponse
