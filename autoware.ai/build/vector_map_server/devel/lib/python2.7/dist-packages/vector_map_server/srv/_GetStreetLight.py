...
"""autogenerated by genpy from vector_map_server/GetStreetLightRequest.msg. Do not edit."""
import codecs
import sys
...
class GetStreetLightRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetStreetLightRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetStreetLightRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetStreetLightResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetStreetLightResponse(genpy.Message):
  _md5sum = "b0be85f5a5560281bab18c92c83ce678"
  _type = "vector_map_server/GetStreetLightResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/StreetLightArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/StreetLightArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetStreetLightResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.StreetLightArray()
    else:
      self.objects = vector_map_msgs.msg.StreetLightArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.StreetLight()
        _x = val1
        start = end
        end += 16
...
def _get_struct_4i():
    ...
    return _struct_4i
class GetStreetLight(object):
  _type          = 'vector_map_server/GetStreetLight'
  _md5sum = 'b54f2ebd1bf276714502d0e99f3c8a4d'
  _request_class  = GetStreetLightRequest
  _response_class = GetStreetLightResponse
