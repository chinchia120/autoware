...
"""autogenerated by genpy from vector_map_server/GetWayAreaRequest.msg. Do not edit."""
import codecs
import sys
...
class GetWayAreaRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetWayAreaRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetWayAreaRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetWayAreaResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetWayAreaResponse(genpy.Message):
  _md5sum = "5f38f4a841033375db12c79fae0e32bb"
  _type = "vector_map_server/GetWayAreaResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/WayAreaArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/WayAreaArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetWayAreaResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.WayAreaArray()
    else:
      self.objects = vector_map_msgs.msg.WayAreaArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.WayArea()
        _x = val1
        start = end
        end += 8
...
def _get_struct_3I():
    ...
    if _struct_3I is None:
        _struct_3I = struct.Struct("<3I")
    return _struct_3I
class GetWayArea(object):
  _type          = 'vector_map_server/GetWayArea'
  _md5sum = '4b13302b5044d109c446dcf59901a39f'
  _request_class  = GetWayAreaRequest
  _response_class = GetWayAreaResponse
