...
"""autogenerated by genpy from vector_map_server/GetLaneRequest.msg. Do not edit."""
import codecs
import sys
...
class GetLaneRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetLaneRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetLaneRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetLaneResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetLaneResponse(genpy.Message):
  _md5sum = "35ee85508b75c3b99d11e09886cc9933"
  _type = "vector_map_server/GetLaneResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/LaneArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/LaneArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetLaneResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.LaneArray()
    else:
      self.objects = vector_map_msgs.msg.LaneArray()
...
def _get_struct_3I():
    ...
    if _struct_3I is None:
        _struct_3I = struct.Struct("<3I")
    return _struct_3I
class GetLane(object):
  _type          = 'vector_map_server/GetLane'
  _md5sum = '5317230a414ba1fca6f1b790da68e0a5'
  _request_class  = GetLaneRequest
  _response_class = GetLaneResponse
