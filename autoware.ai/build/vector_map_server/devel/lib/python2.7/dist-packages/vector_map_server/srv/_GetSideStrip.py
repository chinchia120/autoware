...
"""autogenerated by genpy from vector_map_server/GetSideStripRequest.msg. Do not edit."""
import codecs
import sys
...
class GetSideStripRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetSideStripRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetSideStripRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetSideStripResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetSideStripResponse(genpy.Message):
  _md5sum = "bd9a2abeb71ea61e315c29d2d466b6cb"
  _type = "vector_map_server/GetSideStripResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/SideStripArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/SideStripArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetSideStripResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.SideStripArray()
    else:
      self.objects = vector_map_msgs.msg.SideStripArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.SideStrip()
        _x = val1
        start = end
        end += 12
...
def _get_struct_3i():
    ...
    if _struct_3i is None:
        _struct_3i = struct.Struct("<3i")
    return _struct_3i
class GetSideStrip(object):
  _type          = 'vector_map_server/GetSideStrip'
  _md5sum = '043091db854fb777cc2e28c3df60c47d'
  _request_class  = GetSideStripRequest
  _response_class = GetSideStripResponse
