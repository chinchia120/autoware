...
"""autogenerated by genpy from vector_map_server/GetFenceRequest.msg. Do not edit."""
import codecs
import sys
...
class GetFenceRequest(genpy.Message):
  ...
  _type = "vector_map_server/GetFenceRequest"
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetFenceResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetFenceResponse(genpy.Message):
  ...
  _type = "vector_map_server/GetFenceResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/FenceArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/FenceArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.objects is None:
        self.objects = vector_map_msgs.msg.FenceArray()
    else:
      self.objects = vector_map_msgs.msg.FenceArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects.data = []
      for i in range(0, length):
        val1 = vector_map_msgs.msg.Fence()
        _x = val1
        start = end
        end += 12
...
class GetFence(object):
  _type          = 'vector_map_server/GetFence'
