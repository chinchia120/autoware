...
"""autogenerated by genpy from vector_map_server/GetWallRequest.msg. Do not edit."""
import codecs
import sys
...
class GetWallRequest(genpy.Message):
  _md5sum = "d1f64bdec952e41012fc8c13f57fef77"
  _type = "vector_map_server/GetWallRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetWallRequest, self).__init__(*args, **kwds)
...
def _get_struct_i5B():
    ...
    return _struct_i5B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from vector_map_server/GetWallResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetWallResponse(genpy.Message):
  _md5sum = "3e2316da16f47f9b9b59ab373d7ae8a5"
  _type = "vector_map_server/GetWallResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vector_map_msgs/WallArray objects
...
"""
  __slots__ = ['objects']
  _slot_types = ['vector_map_msgs/WallArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetWallResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.objects is None:
        self.objects = vector_map_msgs.msg.WallArray()
    else:
      self.objects = vector_map_msgs.msg.WallArray()
...
def _get_struct_3i():
    ...
    if _struct_3i is None:
        _struct_3i = struct.Struct("<3i")
    return _struct_3i
class GetWall(object):
  _type          = 'vector_map_server/GetWall'
  _md5sum = '960088d98f027e8a008897cb0578f71b'
  _request_class  = GetWallRequest
  _response_class = GetWallResponse
