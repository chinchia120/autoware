...
if("TRUE" STREQUAL "TRUE")
  set(mrt_cmake_modules_SOURCE_PREFIX /home/point001/autoware.ai/src/vendor/mrt_cmake_modules)
  set(mrt_cmake_modules_DEVEL_PREFIX /home/point001/autoware.ai/build/mrt_cmake_modules/devel)
  ...
  set(mrt_cmake_modules_INSTALL_PREFIX /home/point001/autoware.ai/install/mrt_cmake_modules)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mrt_cmake_modules' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/point001/autoware.ai/src/vendor/mrt_cmake_modules/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT mrt_cmake_modules_NUM_DUMMY_TARGETS)
      set(mrt_cmake_modules_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::mrt_cmake_modules::wrapped-linker-option${mrt_cmake_modules_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR mrt_cmake_modules_NUM_DUMMY_TARGETS "${mrt_cmake_modules_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::mrt_cmake_modules::wrapped-linker-option${mrt_cmake_modules_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND mrt_cmake_modules_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/point001/autoware.ai/build/mrt_cmake_modules/devel/lib;/opt/ros/melodic/lib)
