...
if("TRUE" STREQUAL "TRUE")
  set(gnss_localizer_SOURCE_PREFIX /home/point001/autoware.ai/src/autoware/core_perception/gnss_localizer)
  set(gnss_localizer_DEVEL_PREFIX /home/point001/autoware.ai/build/gnss_localizer/devel)
  ...
  set(gnss_localizer_INSTALL_PREFIX /home/point001/autoware.ai/install/gnss_localizer)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gnss_localizer' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'gnss_localizer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/point001/autoware.ai/src/autoware/core_perception/gnss_localizer/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT gnss_localizer_NUM_DUMMY_TARGETS)
      set(gnss_localizer_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::gnss_localizer::wrapped-linker-option${gnss_localizer_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR gnss_localizer_NUM_DUMMY_TARGETS "${gnss_localizer_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::gnss_localizer::wrapped-linker-option${gnss_localizer_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND gnss_localizer_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/point001/autoware.ai/build/gnss_localizer/devel/lib;/home/point001/autoware.ai/install/gnss/lib;/home/point001/autoware.ai/install/autoware_build_flags/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${gnss_localizer_dep}_FOUND)
      find_package(${gnss_localizer_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${gnss_localizer_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
