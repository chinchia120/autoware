...
set(MSG_I_FLAGS "-Ipoints_downsampler:/home/point001/autoware.ai/src/autoware/core_perception/points_downsampler/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/point001/autoware.ai/src/autoware/core_perception/points_downsampler/msg/PointsDownsamplerInfo.msg" NAME_WE)
add_custom_target(_points_downsampler_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "points_downsampler" "/home/point001/autoware.ai/src/autoware/core_perception/points_downsampler/msg/PointsDownsamplerInfo.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(points_downsampler
  "/home/point001/autoware.ai/src/autoware/core_perception/points_downsampler/msg/PointsDownsamplerInfo.msg"
  "${MSG_I_FLAGS}"
...
### Generating Messages
_generate_msg_nodejs(points_downsampler
  "/home/point001/autoware.ai/src/autoware/core_perception/points_downsampler/msg/PointsDownsamplerInfo.msg"
  "${MSG_I_FLAGS}"
  "/opt/ros/melodic/share/std_msgs/cmake/../msg/Header.msg"
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/points_downsampler
)

### Generating Services

### Generating Module File
_generate_module_nodejs(points_downsampler
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/points_downsampler
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(points_downsampler_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(points_downsampler_generate_messages points_downsampler_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/point001/autoware.ai/src/autoware/core_perception/points_downsampler/msg/PointsDownsamplerInfo.msg" NAME_WE)
add_dependencies(points_downsampler_generate_messages_nodejs _points_downsampler_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(points_downsampler_gennodejs)
add_dependencies(points_downsampler_gennodejs points_downsampler_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS points_downsampler_generate_messages_nodejs)
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/points_downsampler)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/points_downsampler
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(points_downsampler_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/points_downsampler)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/points_downsampler\")")
  # install generated code
  install(
