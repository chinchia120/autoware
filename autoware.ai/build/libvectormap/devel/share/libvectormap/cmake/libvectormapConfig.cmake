...
if("TRUE" STREQUAL "TRUE")
  set(libvectormap_SOURCE_PREFIX /home/point001/autoware.ai/src/autoware/common/libvectormap)
  set(libvectormap_DEVEL_PREFIX /home/point001/autoware.ai/build/libvectormap/devel)
  ...
  set(libvectormap_INSTALL_PREFIX /home/point001/autoware.ai/install/libvectormap)
...
if(NOT "/home/point001/autoware.ai/src/autoware/common/libvectormap/include;/usr/local/include/eigen3 " STREQUAL " ")
  set(libvectormap_INCLUDE_DIRS "")
  set(_include_dirs "/home/point001/autoware.ai/src/autoware/common/libvectormap/include;/usr/local/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libvectormap' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/point001/autoware.ai/src/autoware/common/libvectormap/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT libvectormap_NUM_DUMMY_TARGETS)
      set(libvectormap_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::libvectormap::wrapped-linker-option${libvectormap_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR libvectormap_NUM_DUMMY_TARGETS "${libvectormap_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::libvectormap::wrapped-linker-option${libvectormap_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND libvectormap_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/point001/autoware.ai/build/libvectormap/devel/lib;/home/point001/autoware.ai/install/vector_map/lib;/home/point001/autoware.ai/install/vector_map_msgs/lib;/home/point001/autoware.ai/install/autoware_build_flags/lib;/opt/ros/melodic/lib)
...
set(depends "vector_map;vector_map_msgs")
