...
if("TRUE" STREQUAL "TRUE")
  set(vehicle_socket_SOURCE_PREFIX /home/point001/autoware.ai/src/autoware/utilities/vehicle_socket)
  set(vehicle_socket_DEVEL_PREFIX /home/point001/autoware.ai/build/vehicle_socket/devel)
  ...
  set(vehicle_socket_INSTALL_PREFIX /home/point001/autoware.ai/install/vehicle_socket)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'vehicle_socket' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'vehicle_socket' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/point001/autoware.ai/src/autoware/utilities/vehicle_socket/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT vehicle_socket_NUM_DUMMY_TARGETS)
      set(vehicle_socket_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::vehicle_socket::wrapped-linker-option${vehicle_socket_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR vehicle_socket_NUM_DUMMY_TARGETS "${vehicle_socket_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::vehicle_socket::wrapped-linker-option${vehicle_socket_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND vehicle_socket_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/point001/autoware.ai/build/vehicle_socket/devel/lib;/home/point001/autoware.ai/install/tablet_socket_msgs/lib;/home/point001/autoware.ai/install/autoware_msgs/lib;/home/point001/autoware.ai/install/autoware_can_msgs/lib;/home/point001/autoware.ai/install/autoware_build_flags/lib;/opt/ros/melodic/lib)
...
set(vehicle_socket_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${vehicle_socket_dep}_FOUND)
      find_package(${vehicle_socket_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${vehicle_socket_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
