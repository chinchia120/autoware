...
if("TRUE" STREQUAL "TRUE")
  set(lidar_euclidean_cluster_detect_SOURCE_PREFIX /home/point001/autoware.ai/src/autoware/core_perception/lidar_euclidean_cluster_detect)
  set(lidar_euclidean_cluster_detect_DEVEL_PREFIX /home/point001/autoware.ai/build/lidar_euclidean_cluster_detect/devel)
  ...
  set(lidar_euclidean_cluster_detect_INSTALL_PREFIX /home/point001/autoware.ai/install/lidar_euclidean_cluster_detect)
...
if(NOT "/home/point001/autoware.ai/src/autoware/core_perception/lidar_euclidean_cluster_detect/include " STREQUAL " ")
  set(lidar_euclidean_cluster_detect_INCLUDE_DIRS "")
  set(_include_dirs "/home/point001/autoware.ai/src/autoware/core_perception/lidar_euclidean_cluster_detect/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lidar_euclidean_cluster_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/point001/autoware.ai/src/autoware/core_perception/lidar_euclidean_cluster_detect/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT lidar_euclidean_cluster_detect_NUM_DUMMY_TARGETS)
      set(lidar_euclidean_cluster_detect_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lidar_euclidean_cluster_detect::wrapped-linker-option${lidar_euclidean_cluster_detect_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lidar_euclidean_cluster_detect_NUM_DUMMY_TARGETS "${lidar_euclidean_cluster_detect_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lidar_euclidean_cluster_detect::wrapped-linker-option${lidar_euclidean_cluster_detect_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lidar_euclidean_cluster_detect_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/point001/autoware.ai/build/lidar_euclidean_cluster_detect/devel/lib;/home/point001/autoware.ai/install/vector_map_server/lib;/home/point001/autoware.ai/install/vector_map/lib;/home/point001/autoware.ai/install/vector_map_msgs/lib;/home/point001/autoware.ai/install/autoware_msgs/lib;/home/point001/autoware.ai/install/autoware_build_flags/lib;/opt/ros/melodic/lib)
...
set(depends "vector_map_server;grid_map_ros;grid_map_cv;grid_map_msgs;jsk_rviz_plugins")
