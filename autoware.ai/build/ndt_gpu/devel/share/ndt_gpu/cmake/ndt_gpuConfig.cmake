...
if(ndt_gpu_CONFIG_INCLUDED)
  return()
endif()
set(ndt_gpu_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(ndt_gpu_SOURCE_PREFIX /home/point001/autoware.ai/src/autoware/core_perception/ndt_gpu)
  set(ndt_gpu_DEVEL_PREFIX /home/point001/autoware.ai/build/ndt_gpu/devel)
  set(ndt_gpu_INSTALL_PREFIX "")
  set(ndt_gpu_PREFIX ${ndt_gpu_DEVEL_PREFIX})
else()
  set(ndt_gpu_SOURCE_PREFIX "")
  set(ndt_gpu_DEVEL_PREFIX "")
  set(ndt_gpu_INSTALL_PREFIX /home/point001/autoware.ai/install/ndt_gpu)
  set(ndt_gpu_PREFIX ${ndt_gpu_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'ndt_gpu' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND ndt_gpu_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/point001/autoware.ai/build/ndt_gpu/devel/lib;/home/point001/autoware.ai/install/autoware_build_flags/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(ndt_gpu_LIBRARY_DIRS ${lib_path})
      list(APPEND ndt_gpu_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'ndt_gpu'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND ndt_gpu_LIBRARIES ${lib})
    endif()
  endif()
...
set(ndt_gpu_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${ndt_gpu_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 ndt_gpu_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${ndt_gpu_dep}_FOUND)
      find_package(${ndt_gpu_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ndt_gpu_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(ndt_gpu_INCLUDE_DIRS ${${ndt_gpu_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(ndt_gpu_LIBRARIES ${ndt_gpu_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${ndt_gpu_dep}_LIBRARIES})
  _list_append_deduplicate(ndt_gpu_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(ndt_gpu_LIBRARIES ${ndt_gpu_LIBRARIES})

  _list_append_unique(ndt_gpu_LIBRARY_DIRS ${${ndt_gpu_dep}_LIBRARY_DIRS})
  list(APPEND ndt_gpu_EXPORTED_TARGETS ${${ndt_gpu_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${ndt_gpu_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
