...
if("TRUE" STREQUAL "TRUE")
  set(log_tools_SOURCE_PREFIX /home/point001/autoware.ai/src/autoware/utilities/log_tools)
  set(log_tools_DEVEL_PREFIX /home/point001/autoware.ai/build/log_tools/devel)
  ...
  set(log_tools_INSTALL_PREFIX /home/point001/autoware.ai/install/log_tools)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'log_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/point001/autoware.ai/src/autoware/utilities/log_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT log_tools_NUM_DUMMY_TARGETS)
      set(log_tools_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::log_tools::wrapped-linker-option${log_tools_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR log_tools_NUM_DUMMY_TARGETS "${log_tools_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::log_tools::wrapped-linker-option${log_tools_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND log_tools_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/point001/autoware.ai/build/log_tools/devel/lib;/home/point001/autoware.ai/install/autoware_build_flags/lib;/opt/ros/melodic/lib)
