...
if("TRUE" STREQUAL "TRUE")
  set(sick_ldmrs_msgs_SOURCE_PREFIX /home/point001/autoware.ai/src/drivers/awf_drivers/sick_ldmrs_msgs)
  set(sick_ldmrs_msgs_DEVEL_PREFIX /home/point001/autoware.ai/build/sick_ldmrs_msgs/devel)
  ...
  set(sick_ldmrs_msgs_INSTALL_PREFIX /home/point001/autoware.ai/install/sick_ldmrs_msgs)
...
if(NOT "/home/point001/autoware.ai/build/sick_ldmrs_msgs/devel/include;/home/point001/autoware.ai/src/drivers/awf_drivers/sick_ldmrs_msgs/include " STREQUAL " ")
  set(sick_ldmrs_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/point001/autoware.ai/build/sick_ldmrs_msgs/devel/include;/home/point001/autoware.ai/src/drivers/awf_drivers/sick_ldmrs_msgs/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://wiki.ros.org/sick_ldmrs_msgs " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/sick_ldmrs_msgs' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sick_ldmrs_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/point001/autoware.ai/src/drivers/awf_drivers/sick_ldmrs_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT sick_ldmrs_msgs_NUM_DUMMY_TARGETS)
      set(sick_ldmrs_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::sick_ldmrs_msgs::wrapped-linker-option${sick_ldmrs_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR sick_ldmrs_msgs_NUM_DUMMY_TARGETS "${sick_ldmrs_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::sick_ldmrs_msgs::wrapped-linker-option${sick_ldmrs_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND sick_ldmrs_msgs_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/point001/autoware.ai/build/sick_ldmrs_msgs/devel/lib;/opt/ros/melodic/lib)
