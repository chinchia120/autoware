...
if("TRUE" STREQUAL "TRUE")
  set(gnss_SOURCE_PREFIX /home/point001/autoware.ai/src/autoware/common/gnss)
  set(gnss_DEVEL_PREFIX /home/point001/autoware.ai/build/gnss/devel)
  set(gnss_INSTALL_PREFIX "")
  set(gnss_PREFIX ${gnss_DEVEL_PREFIX})
else()
  set(gnss_SOURCE_PREFIX "")
  set(gnss_DEVEL_PREFIX "")
  set(gnss_INSTALL_PREFIX /home/point001/autoware.ai/install/gnss)
...
if(NOT "/home/point001/autoware.ai/src/autoware/common/gnss/include " STREQUAL " ")
  set(gnss_INCLUDE_DIRS "")
  set(_include_dirs "/home/point001/autoware.ai/src/autoware/common/gnss/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gnss' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/point001/autoware.ai/src/autoware/common/gnss/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/point001/autoware.ai/build/gnss/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND gnss_EXPORTED_TARGETS ${${gnss_dep}_EXPORTED_TARGETS})
endforeach()
