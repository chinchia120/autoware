...
if("TRUE" STREQUAL "TRUE")
  set(op_utility_SOURCE_PREFIX /home/point001/autoware.ai/src/autoware/common/op_utility)
  set(op_utility_DEVEL_PREFIX /home/point001/autoware.ai/build/op_utility/devel)
  ...
  set(op_utility_INSTALL_PREFIX /home/point001/autoware.ai/install/op_utility)
...
if(NOT "/home/point001/autoware.ai/src/autoware/common/op_utility/include " STREQUAL " ")
  set(op_utility_INCLUDE_DIRS "")
  set(_include_dirs "/home/point001/autoware.ai/src/autoware/common/op_utility/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'op_utility' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/point001/autoware.ai/src/autoware/common/op_utility/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT op_utility_NUM_DUMMY_TARGETS)
      set(op_utility_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::op_utility::wrapped-linker-option${op_utility_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR op_utility_NUM_DUMMY_TARGETS "${op_utility_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::op_utility::wrapped-linker-option${op_utility_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND op_utility_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/point001/autoware.ai/build/op_utility/devel/lib;/home/point001/autoware.ai/install/vector_map_server/lib;/home/point001/autoware.ai/install/vector_map/lib;/home/point001/autoware.ai/install/vector_map_msgs/lib;/home/point001/autoware.ai/install/autoware_msgs/lib;/home/point001/autoware.ai/install/autoware_build_flags/lib;/opt/ros/melodic/lib)
