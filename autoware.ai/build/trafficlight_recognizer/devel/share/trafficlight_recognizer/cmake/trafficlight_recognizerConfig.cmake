...
if("TRUE" STREQUAL "TRUE")
  set(trafficlight_recognizer_SOURCE_PREFIX /home/point001/autoware.ai/src/autoware/core_perception/trafficlight_recognizer)
  set(trafficlight_recognizer_DEVEL_PREFIX /home/point001/autoware.ai/build/trafficlight_recognizer/devel)
  ...
  set(trafficlight_recognizer_INSTALL_PREFIX /home/point001/autoware.ai/install/trafficlight_recognizer)
...
if(NOT "/usr/local/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'trafficlight_recognizer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/point001/autoware.ai/src/autoware/core_perception/trafficlight_recognizer/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT trafficlight_recognizer_NUM_DUMMY_TARGETS)
      set(trafficlight_recognizer_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::trafficlight_recognizer::wrapped-linker-option${trafficlight_recognizer_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR trafficlight_recognizer_NUM_DUMMY_TARGETS "${trafficlight_recognizer_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::trafficlight_recognizer::wrapped-linker-option${trafficlight_recognizer_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND trafficlight_recognizer_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/point001/autoware.ai/build/trafficlight_recognizer/devel/lib;/home/point001/autoware.ai/install/lanelet2_extension/lib;/home/point001/autoware.ai/install/lanelet2_validation/lib;/home/point001/autoware.ai/install/lanelet2_routing/lib;/home/point001/autoware.ai/install/lanelet2_projection/lib;/home/point001/autoware.ai/install/vector_map_server/lib;/home/point001/autoware.ai/install/libvectormap/lib;/home/point001/autoware.ai/install/lanelet2_traffic_rules/lib;/home/point001/autoware.ai/install/lanelet2_maps/lib;/home/point001/autoware.ai/install/lanelet2_io/lib;/home/point001/autoware.ai/install/vector_map/lib;/home/point001/autoware.ai/install/lanelet2_core/lib;/home/point001/autoware.ai/install/amathutils_lib/lib;/home/point001/autoware.ai/install/vector_map_msgs/lib;/home/point001/autoware.ai/install/autoware_msgs/lib;/home/point001/autoware.ai/install/autoware_lanelet2_msgs/lib;/home/point001/autoware.ai/install/autoware_build_flags/lib;/opt/ros/melodic/lib)
