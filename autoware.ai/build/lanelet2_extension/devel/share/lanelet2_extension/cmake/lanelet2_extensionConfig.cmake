...
if("TRUE" STREQUAL "TRUE")
  set(lanelet2_extension_SOURCE_PREFIX /home/point001/autoware.ai/src/autoware/common/lanelet2_extension)
  set(lanelet2_extension_DEVEL_PREFIX /home/point001/autoware.ai/build/lanelet2_extension/devel)
  ...
  set(lanelet2_extension_INSTALL_PREFIX /home/point001/autoware.ai/install/lanelet2_extension)
...
if(NOT "/home/point001/autoware.ai/src/autoware/common/lanelet2_extension/include " STREQUAL " ")
  set(lanelet2_extension_INCLUDE_DIRS "")
  set(_include_dirs "/home/point001/autoware.ai/src/autoware/common/lanelet2_extension/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lanelet2_extension' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/point001/autoware.ai/src/autoware/common/lanelet2_extension/${idir}'.  ${_report}")
    endif()
...
set(depends "amathutils_lib;autoware_lanelet2_msgs;autoware_msgs;geometry_msgs;lanelet2_core;lanelet2_io;lanelet2_maps;lanelet2_projection;lanelet2_routing;lanelet2_traffic_rules;lanelet2_validation;visualization_msgs")
foreach(depend ${depends})
  ...
  list(APPEND lanelet2_extension_EXPORTED_TARGETS ${${lanelet2_extension_dep}_EXPORTED_TARGETS})
endforeach()
