...
if("TRUE" STREQUAL "TRUE")
  set(multi_lidar_calibrator_SOURCE_PREFIX /home/point001/autoware.ai/src/autoware/utilities/multi_lidar_calibrator)
  set(multi_lidar_calibrator_DEVEL_PREFIX /home/point001/autoware.ai/build/multi_lidar_calibrator/devel)
  ...
  set(multi_lidar_calibrator_INSTALL_PREFIX /home/point001/autoware.ai/install/multi_lidar_calibrator)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_lidar_calibrator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/point001/autoware.ai/src/autoware/utilities/multi_lidar_calibrator/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/point001/autoware.ai/build/multi_lidar_calibrator/devel/lib;/home/point001/autoware.ai/install/autoware_build_flags/lib;/opt/ros/melodic/lib)
