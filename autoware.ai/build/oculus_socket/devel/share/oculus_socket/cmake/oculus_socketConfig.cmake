...
if("TRUE" STREQUAL "TRUE")
  set(oculus_socket_SOURCE_PREFIX /home/point001/autoware.ai/src/autoware/utilities/oculus_socket)
  set(oculus_socket_DEVEL_PREFIX /home/point001/autoware.ai/build/oculus_socket/devel)
  ...
  set(oculus_socket_INSTALL_PREFIX /home/point001/autoware.ai/install/oculus_socket)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Yamada K <ni519@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'oculus_socket' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'oculus_socket' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/point001/autoware.ai/src/autoware/utilities/oculus_socket/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT oculus_socket_NUM_DUMMY_TARGETS)
      set(oculus_socket_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::oculus_socket::wrapped-linker-option${oculus_socket_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR oculus_socket_NUM_DUMMY_TARGETS "${oculus_socket_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::oculus_socket::wrapped-linker-option${oculus_socket_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND oculus_socket_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/point001/autoware.ai/build/oculus_socket/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${oculus_socket_dep}_FOUND)
      find_package(${oculus_socket_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${oculus_socket_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
